...
kernel:
	gcc -c -I src src/kmain.c -o ${OUTDIR}/objs/kernel.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -m32 -fno-pic -no-pie -g -mgeneral-regs-only -mno-red-zone -fno-stack-protector -Os
bin:
